...
const ServiceOptions = () => {
  const services = [
    ...
    },
    {
      ...
      details: [
        ...
        "project planning and deveopment",
  ...
  return (
    ...
    >
        ...
        >
          <div className="text py-6">
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold capitalize leading-snug dark:text-white">
              Explore unique software <br className="hidden sm:block" />{" "}
              solutions
            </h1>
            <p className="text-md sm:text-base leading-relaxed mt-2 dark:text-white">
              ...
              successful. From websites and mobile apps to user-friendly designs
              and branding, we help companies create a strong online presence.
              Our goal is to turn ideas into real solutions that improve
              efficiency, connect with audiences, and drive growth in today’s
              digital world.
            </p>
          </div>
      ...
      >
        <Link
          className="p-3 bg-[#870A81] text-white rounded-full flex items-center gap-2 hover:scale-105 transition-transform duration-300 font-medium text-sm md:text-base"
          to={"/services"}
        >
