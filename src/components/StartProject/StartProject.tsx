          ...
          <form ref={formRef} onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormControl>
                    <Input placeholder="Email" {...field} className="w-full p-3 border rounded-lg" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormControl>
                    <Textarea placeholder="Project Description" {...field} className="w-full p-3 border rounded-lg" rows={4} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Button type="submit" className="w-full bg-blue-600 text-white py-3 rounded-lg">Submit Project</Button>
            </motion.div>
          </form>
        </Form>
      </div>
