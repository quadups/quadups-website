...
export const Mission = () => {
  return (
    <div className="p-5 sm:p-20 flex items-center justify-center flex-col bg-white dark:bg-[#1E1E1E]">
      <div className="mission p-6 sm:p-16 flex flex-col-reverse sm:flex-row justify-between w-full items-center">
        <MotionBox
...
const MotionBox: React.FC<BoxProps> = ({ color, writeUp, title, rotate }) => {
  return (
    <motion.div
      ...
      className="write-up w-full sm:w-96 py-8 px-2 border-black border-4 text-white shadow-lg"
