  ...
  return (
    <div className="p-20 flex items-center justify-center flex-col">
        <div className="mission p-16 flex justify-between w-full">
           ...
           rotate="8.08deg"
            />
            <h1 className="title capitalize text-3xl font-semibold flex items-end">our mission</h1>
        </div>

        <div className="vision p-16 flex justify-between w-full">
        <h1 className="title capitalize text-3xl font-semibold flex items-end">our vision</h1>
        <Box 
           color={`rgb(56,5,158)`}
           title={'vision'} 
